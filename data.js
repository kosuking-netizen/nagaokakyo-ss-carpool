...
window.APP_DATA = {
  ...
  gasPrice: {
    ...
    checked: "2026-09-17", // [AUTO-GAS-CHECKED] 自動チェックが最後に走った日（変更がなくても記録）
  },
  ...
  apiQuota: {
    route: {
      remaining: 362, // [AUTO-QUOTA-ROUTE-REMAINING]
      limit: 500, // [AUTO-QUOTA-ROUTE-LIMIT]
      resetOn: "2026-09-18", // [AUTO-QUOTA-ROUTE-RESET]
      checked: "2026-09-17", // [AUTO-QUOTA-ROUTE-CHECKED]
    },
    spot: {
      remaining: 367, // [AUTO-QUOTA-SPOT-REMAINING]
      limit: 500, // [AUTO-QUOTA-SPOT-LIMIT]
      resetOn: "2026-09-18", // [AUTO-QUOTA-SPOT-RESET]
      checked: "2026-09-17", // [AUTO-QUOTA-SPOT-CHECKED]
    },
  },
};
