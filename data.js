...
// ============================================================
window.APP_DATA = {
  dataUpdated: "2026-09-04", // [AUTO-UPDATED]
  ...
  gasPrice: {
    price: 172.5, // [AUTO-GAS-PRICE]
    week: "2026-08-31", // [AUTO-GAS-WEEK]
    checked: "2026-09-05", // [AUTO-GAS-CHECKED] 自動チェックが最後に走った日（変更がなくても記録）
  },
  ...
  apiQuota: {
    route: {
      remaining: 408, // [AUTO-QUOTA-ROUTE-REMAINING]
      limit: 500, // [AUTO-QUOTA-ROUTE-LIMIT]
      resetOn: "2026-09-18", // [AUTO-QUOTA-ROUTE-RESET]
      checked: "2026-09-06", // [AUTO-QUOTA-ROUTE-CHECKED]
    },
    spot: {
      remaining: 418, // [AUTO-QUOTA-SPOT-REMAINING]
      limit: 500, // [AUTO-QUOTA-SPOT-LIMIT]
      resetOn: "2026-09-18", // [AUTO-QUOTA-SPOT-RESET]
      checked: "2026-09-06", // [AUTO-QUOTA-SPOT-CHECKED]
    },
  },
};
